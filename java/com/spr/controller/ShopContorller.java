...
public class ShopContorller {
	...
	public ModelAndView editShop(@ModelAttribute @Valid Shop shop, BindingResult result, @PathVariable Integer id, final RedirectAttributes redirectattributes) throws ShopNotFound { 
	...
	redirectattributes.addFlashAttribute("message", message); //Add the message with index.html via flash attributes instead of query string.
	return mav;
	}
